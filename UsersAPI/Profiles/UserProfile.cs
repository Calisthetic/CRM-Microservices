        ...
        public UserProfile() {
            CreateMap<NewUserDto, User>()
                ...
                .ForMember(dest => dest.SecondName, opt => opt.MapFrom(src => 
                    src.SecondName.Substring(0, 1).ToUpper() + src.SecondName.Substring(1, src.SecondName.Length - 1).ToLower()))
                .ForMember(dest => dest.ThirdName, opt => opt.MapFrom(src => src.ThirdName == null ? null : 
                    src.ThirdName.Substring(0, 1).ToUpper() + src.ThirdName.Substring(1, src.ThirdName.Length - 1).ToLower()))
